...
export function HomePage({ onNavigate }: HomePageProps) {
  const features = [
    ...
    },
    {
      icon: FileText,
      title: "Report Issues",
      description: "Submit problems with your rental property to get help",
      action: "feedback",
    },
  ];
      ...
      <div className="py-20 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Don't wait. Start a conversation with our AI assistant or report an
            issue with your rental property today.
          </p>
